...
import com.cg.springboot.dto.SchedulerResponse;
import com.cg.springboot.service.SchedulerService;
...
public class SchedulerController {
	...
	public SchedulerResponse searchScheduler(@RequestParam("scheduleid") int scheduleid) {
		SchedulerResponse response = new SchedulerResponse();
